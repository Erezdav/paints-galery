    ...
    <Wrapper>
      <div className="box-container">
        <article>
          ...
          <p>
            ציוריה של הניה מלאי חיים ומעבירים את אהבתה לעולם הטבע ואת הרגעים
            הקטנים והפשוטים של חיי היומיום. עבודותיה מלאות הומור וחן, והן
            מעניקות מבט נוסטלגי ואופטימי על החיים. ציוריה של הניה מוצגות מעת לעת
            בתערוכות פרטיות בקצרין. עבודותיה מעניקות לנו הצופים חוויה ייחודית
            ומרגשת.
          </p>
        </article>
        <Link
