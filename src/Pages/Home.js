    ...
    <Wrapper>
      <div className="box-container">
        <article>
          ...
          <p>
            הניה היא ציירת המתגוררת ברמת הגולן. במשך השנים ציירה עשרות ציורים
            מקוריים בצבעי שמן, המשקפים את אהבתה לנוף הכפרי, הטבע והאנשים. כאמא
            וכסבתא היא יודעת ללכוד במבטה החד את רגעי החן וההומור שבחיי היומיום.
          </p>
          ...
          <p>
            ציוריה של הניה מלאי חיים ומעבירים את אהבתה לנופי הטבע, לנופים כפריים
            ואת הרגעים הקטנים והפשוטים של חיי היומיום. עבודותיה מלאות הומור וחן,
            והן מעניקות מבט נוסטלגי ואופטימי על החיים. ציוריה של הניה מוצגות מעת
            לעת בתערוכות פרטיות בקצרין.עבודותיה מעניקות לנו הצופים חוויה ייחודית
            ומרגשת.
          </p>
        </article>
