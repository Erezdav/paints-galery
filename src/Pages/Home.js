    ...
    <Wrapper>
      <div className="box-container">
        <article>
          ...
          <p>
            שמי הניה דוידוביץ ואני אמנית וציירת המתגוררת ברמת הגולן. לאורך השנים
            התמקדתי ביצירת תכשיטים, רקמות עמים ועבודות תוויה וסריגה. בשנים
            האחרונות נחשפתי לעולם הציור וציירתי עשרות ציורים מקוריים בצבעי שמן,
            המשקפים את אהבתי לפשטות, לנוף הכפרי, הטבע והאנשים. כאמא וכסבתא אני
            מבקשת ללכוד בציוריי את רגעי החן וההומור שבחיי היומיום.
          </p>
